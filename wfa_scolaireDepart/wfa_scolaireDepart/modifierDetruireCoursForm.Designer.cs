namespace wfa_scolaireDepart
{
    partial class modifierDetruireCoursForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            modifAttachButton = new Button();
            detruireAttachButton = new Button();
            ...
            // modifAttachButton
            // 
            modifAttachButton.Font = new Font("Segoe UI", 12F);
            modifAttachButton.Location = new Point(128, 394);
            modifAttachButton.Margin = new Padding(3, 2, 3, 2);
            modifAttachButton.Name = "modifAttachButton";
            modifAttachButton.Size = new Size(132, 41);
            modifAttachButton.TabIndex = 9;
            modifAttachButton.Text = "Modifier Attach";
            modifAttachButton.UseVisualStyleBackColor = true;
            modifAttachButton.Click += modifAttachButton_Click;
            // 
            // detruireAttachButton
            // 
            detruireAttachButton.Font = new Font("Segoe UI", 12F);
            detruireAttachButton.Location = new Point(368, 394);
            detruireAttachButton.Margin = new Padding(3, 2, 3, 2);
            detruireAttachButton.Name = "detruireAttachButton";
            detruireAttachButton.Size = new Size(132, 41);
            ...
            Controls.Add(detruireAttachButton);
            Controls.Add(modifAttachButton);
        ...
        private Button modifAttachButton;
        private Button detruireAttachButton;
    }
}